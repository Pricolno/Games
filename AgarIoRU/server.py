...
main_socket.bind((SERVER_IP, MAIN_PORT))
...
pygame.display.set_caption('Server: Agario.RU')
...
# every 100 or 200 something is happening
delay_tick = -1
server_work = True
...
while server_work:
    ...
    if delay_tick == 200:
        ...
        try:
            ...
            print('Connected client with IP={0}'.format(addr))
    ...
    # определим, кого видит каждый игрок
    ...
    for i in range(len(players)):
        ...
        for j in range(len(players)):
            if i == j:
                continue
            # рассматриваем пару i и j игрока (i видит j)
